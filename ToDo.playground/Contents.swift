...
//Based on Sessions 1 - 3 (Basics | DataTypes | Operators, Strings & Characters, Control Flow), create a playground that will manage your todos.
//
//You will need to:
//
...
var Todo =  (("Wash Car.", "Drive to the local carwash."),
            ("Buy a house.", "Contact your bank about a mortgage loan0"),
            ("Grocery shopping.", "Buy and prepare your food for the next week."))


//Printing the small description of each Todo
print(Todo.0.0)
print(Todo.1.0)
print(Todo.2.0)

//Printing the large description of each Todo
print(Todo.0.1)
print(Todo.1.1)
print(Todo.2.1)

var newTodo = (("Apply for internships.", "Update your resume to include your github."))



Todo.insert(["Apply for scholarship", "f"])
...
//Declare and initialize array of tuples
let todos = (
...
//  Created a new mirror object that lets you reflect over each item and access to speical methods.
//From what I read online, Mirror is used to 
